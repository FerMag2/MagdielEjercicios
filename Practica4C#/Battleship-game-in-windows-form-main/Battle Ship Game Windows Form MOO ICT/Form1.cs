    ...
    public partial class Form1 : Form
    {
        ...
        private void EnemyPlayTimerEvent(object sender, EventArgs e)
        {
            ...
            if (round < 1 || enemyScore > 2 || playerScore > 2)
            {
                ...
                {
                    MessageBox.Show("Haha, losiento", "perderdor");
                    RestartGame();
                }
                else if (enemyScore == playerScore)
                {
                    MessageBox.Show("nadie gana este juego", "Dibujo");
                    RestartGame();
                }
            }
        ...
        private void AttackButtonEvent(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Elija una ubicación del menú desplegable primero", "Información");
            }
        }
        ...
        private void PlayerPositionButtonsEvent(object sender, EventArgs e)
        {
            ...
            if (totalShips == 0)
            {
                ...
                txtHelp.Text = "2) Ahora elige la posición de ataque del menú desplegable.";
            }
        ...
        private void RestartGame()
        {
            ...
            txtHelp.Text = "1) ¡Haz clic en tres ubicaciones diferentes desde arriba para comenzar!";
