...
public class Game implements KeyListener {
    ...
    public Game() {
        ...
        String message = "Fácil hará movimientos totalmente aleatorios,\\nMedio se centrará en áreas donde encuentra barcos\",\n" + 
        		"                + \"\\ny Duro tomará decisiones más inteligentes sobre Medio.";
